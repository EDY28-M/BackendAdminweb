...
export declare class MerchantService {
    ...
    getStoresByMerchant(merchantId: string): Promise<({
        business_categories: {
            id: string;
            code: string;
            name: string;
    ...
    ensureStoreBelongsToMerchant(merchantId: string, storeId: string): Promise<{
        id: string;
        merchant_id: string;
        business_category_id: string;
        name: string;
    ...
    getCatalogByStore(merchantId: string, storeId: string): Promise<({
        catalog_categories: {
            id: string;
            store_id: string;
    ...
    getCatalogCategories(merchantId: string, storeId: string): Promise<{
        id: string;
        store_id: string;
        parent_id: string | null;
        name: string;
    ...
    getCatalogCategoriesAll(merchantId: string, storeId: string): Promise<{
        id: string;
        store_id: string;
        parent_id: string | null;
        name: string;
    ...
    updateCatalogCategory(merchantId: string, categoryId: string, data: any): Promise<{
        id: string;
        store_id: string;
        parent_id: string | null;
        name: string;
    ...
    deleteCatalogCategory(merchantId: string, categoryId: string): Promise<{
        success: boolean;
    }>;
    createCatalogItem(merchantId: string, data: any): Promise<{
        id: string;
        store_id: string;
        category_id: string | null;
        item_type: import(".prisma/client").$Enums.item_type_enum;
    ...
    updateCatalogItem(merchantId: string, itemId: string, data: any): Promise<{
        id: string;
        store_id: string;
        category_id: string | null;
        item_type: import(".prisma/client").$Enums.item_type_enum;
    ...
    deleteCatalogItem(merchantId: string, itemId: string): Promise<{
        success: boolean;
    }>;
    createCatalogCategory(merchantId: string, data: any): Promise<{
        id: string;
        store_id: string;
        parent_id: string | null;
        name: string;
    ...
    getOrdersByMerchant(merchantId: string): Promise<({
        store_branches: {
            id: string;
            store_id: string;
            address_id: string;
